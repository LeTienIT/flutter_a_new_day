...
class $MoodsTable extends Moods with TableInfo<$MoodsTable, Mood> {
  ...
  @override
  List<GeneratedColumn> get $columns => [id, date, emoji, note];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
...
class Mood extends DataClass implements Insertable<Mood> {
  ...
  @override
  int get hashCode => Object.hash(id, date, emoji, note);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is Mood &&
          ...
          updateCompanionCallback:
              ({
                ...
                Value<String?> note = const Value.absent(),
                  ...
                  MoodsCompanion(id: id, date: date, emoji: emoji, note: note),
          createCompanionCallback:
              ({
                Value<int> id = const Value.absent(),
                required DateTime date,
